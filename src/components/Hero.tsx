        ...
        <section id="home" className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden bg-[#02040a]">
            ...
            <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 lg:gap-8 items-center z-10">
                ...
                <motion.div
                    ...
                    className="text-left pt-10 lg:pt-0"
                >
                    <div className="flex items-center mb-6 md:mb-8 group/dept">
                        <motion.div
                            initial={{ width: 0, opacity: 0 }}
                            animate={{ width: "auto", opacity: 1 }}
                            transition={{ duration: 1, ease: "circOut" }}
                            className="flex items-center gap-3 px-3 md:px-4 py-2 rounded-full bg-gradient-to-r from-purple-500/10 to-cyan-500/10 border border-white/10 backdrop-blur-md group-hover/dept:border-purple-500/40 transition-all duration-500"
                        >
                            <div className="w-2 h-2 rounded-full bg-purple-500 shadow-[0_0_10px_#a855f7]" />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-white to-cyan-400 font-mono tracking-[0.2em] text-[8px] sm:text-[10px] md:text-[14px] uppercase font-black whitespace-nowrap">
                                Department of Information Technology
                            </span>
                        </motion.div>
                    </div>

                    <h1 className="flex flex-nowrap items-center gap-x-1.5 sm:gap-x-3 mb-4 md:mb-6 text-xl sm:text-2xl md:text-3xl font-black uppercase tracking-tighter cursor-default whitespace-nowrap">
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-500">
                            Code.
                        </span>

                        <span className="text-white/40 font-light text-lg sm:text-xl md:text-2xl select-none mx-0.5 sm:mx-1">|</span>
                    ...
                    <p className="text-gray-200 text-base md:text-lg mb-8 md:mb-10 max-w-md leading-relaxed md:leading-loose border-l-2 border-purple-500/30 pl-4 md:pl-6">
                        Join the elite developers at{" "}
                        <motion.strong
                            whileHover={{ scale: 1.05, rotate: -1 }}
                            className="kaushan-script-regular text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-400 cursor-pointer inline-block transition-all duration-300 text-xl font-bold md:text-2xl drop-shadow-[0_0_8px_rgba(255,255,255,0.2)] px-1"
                        >
                            PyTech Arena
                        </motion.strong>.
                    ...
                    <div className="flex flex-wrap gap-4 mb-10 md:mb-12">
                        <Link
                            href="/#tracks"
                            className="group relative flex items-center justify-center px-4 md:px-6 py-3 md:py-4 
             bg-white text-black font-bold rounded-xl overflow-hidden transition-all 
             hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(255,255,255,0.1)] 
             text-sm md:text-base"
                        >
                            <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-cyan-400 to-purple-600
                  opacity-0 group-hover:opacity-100 transition-opacity" />
                    ...
                    <div className="relative group/timer max-w-sm sm:max-w-md mt-[-10px]">
                        ...
                        <div className="relative bg-white/[0.03] backdrop-blur-md border border-white/10 rounded-2xl p-4 md:p-6 flex flex-col gap-4 shadow-2xl">
                            <div className="flex items-center justify-between border-b border-white/5 pb-3">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[8px] md:text-[9px] font-mono text-gray-400 uppercase tracking-[0.3em] font-bold">Protocol_Launch_Sequence</span>
                                </div>
                                <div className="h-1.5 w-1.5 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(160,185,129,0.5)]" />
                            </div>
                ...
                >
                    ...
                    <div className="relative w-full max-w-[320px]  sm:max-w-[370px] md:max-w-[420px] lg:max-w-[470px] md:max-w-md aspect-square bg-gradient-to-br from-gray-900 to-black rounded-3xl border border-white/10 p-1 shadow-2xl shadow-purple-900/40 rotate-3 hover:rotate-0 transition-all duration-700 ease-out group">
                        ...
                        <div className="relative h-full w-full bg-[#050510] rounded-[1.3rem] p-4 sm:p-6 md:p-8 flex flex-col justify-between overflow-hidden">
                            {/* Grid overlay */}
                            <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:20px_20px]" />

                            <div className="relative z-10 h-full flex flex-col justify-center">
                                <div className="flex items-center gap-4 mb-8">
                                    <div className="lg:w-12 lg:h-12 md:w-10 md:h-10 w-8 h-8 bg-white/5 backdrop-blur-xl lg:rounded-xl md:rounded-lg rounded-md border border-white/10 flex items-center justify-center shadow-inner group-hover:border-cyan-500/50 transition-colors shrink-0">
                                ...
                                <div className="space-y-6">
                                    <div className="flex flex-col gap-2">
                                        <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-white leading-none uppercase tracking-tighter flex flex-wrap items-center gap-x-2 sm:gap-x-3 gap-y-2">
                                            <span>PyTech</span>
                                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">Arena</span>
                                            <span className="px-3 py-1 bg-white/5 border border-white/10 rounded-lg md:text-[20px] text-[18px] font-black italic tracking-[0.2em] text-cyan-400 holographic-text">
                                                BUILDATHON
                                            </span>
                                        </h3>
                                    </div>
                    ...
                    <motion.div
                        ...
                        className="absolute lg:top-20 top-12 md:top-16 -lg:right-2 -right-2 lg:w-24 lg:h-24 md:w-20 md:h-20 w-16 h-16 bg-purple-600/20 backdrop-blur-md rounded-2xl border border-white/10 flex items-center justify-center shadow-2xl"
                    >
                    ...
                    <motion.div
                        ...
                        className="absolute lg:bottom-20 md:bottom-14 bottom-12 -lg:left-10 -md:left-8 -left-4 lg:w-20 lg:h-20 md:w-18 md:h-18 w-16 h-16 bg-cyan-600/20 backdrop-blur-md rounded-full border border-white/10 flex items-center justify-center shadow-2xl"
                    >
